            ...
            if (!is_writable($image_folder)) {
                ...
                if ($image_size > 2000000) {
                    ...
                    if (move_uploaded_file($image_tmp_name, $image_path)) {
                        $old_image_path = 'C:/xampp/htdocs/PhoneSell/../assets/uploads/' . $old_image;
...
<section class="update-product">
    ...
    <?php if ($fetch_product): ?>
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <img src="../assets/uploads/<?php echo htmlspecialchars($fetch_product['image']); ?>" alt="" class="cart-image">
