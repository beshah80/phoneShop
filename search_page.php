...
if(isset($_POST['add_to_wishlist'])){
    ...
    if(!isset($user_id)){
        // Store wishlist items in session for non-logged-in users
...
<section class="search-form">
    <form action="" method="POST">
        <input type="text" class="box" placeholder="search phones..." name="search_box">
...
<section class="products" style="padding-top: 0;">
    ...
    <div class="box-container">
        ...
        <?php
                    ...
                    echo '<p class="empty">no phones found!</p>';
                }
            }else{
                echo '<p class="empty">search for a phone!</p>';
            }
        ?>
